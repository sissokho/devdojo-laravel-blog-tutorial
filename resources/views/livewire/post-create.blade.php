<div>
    <div class="container mx-auto px-4">
        ...
        <p class="text-lg mt-2 text-gray-600">
            Start crafting your new post below
        </p>
        ...
        <div class="space-y-8 divide-y divide-gray-200 w-1/2 mt-10">
            ...
            <div class="sm:col-span-6">
                ...
                @error('post.title')
                <span class="text-red-500 text-xs">Please provide a title for the post.</span>
                @enderror
            </div>
            <div class="sm:col-span-6 pt-5">
                ...
                @error('post.body')
                <span class="text-red-500 text-xs">Add the body for your post.</span>
                @enderror
            </div>
